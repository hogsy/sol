...
#define UI_DrawPrecisePicST(x, y, w, h, st, a, c, p)	SCR_DrawPicUnscaled(x, y, w, h, vec2_origin, st, vec2_origin, a, c, false, p, NULL)
#define	UI_ScaledScreen									SCR_ScaledScreen
#define UI_GetScreenScale								SCR_GetScreenScale
