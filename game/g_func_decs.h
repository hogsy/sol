...
extern int Q_SortStrcmp ( const void * arg1 , const void * arg2 ) ;
...
extern mmove_t * FindMmoveByName ( const char * name ) ;
extern mmoveList_t * GetMmoveByAddress ( const mmove_t * adr ) ;
extern byte * FindFunctionByName ( const char * name ) ;
extern functionList_t * GetFunctionByAddress ( const byte * adr ) ;
...
extern float realrange ( edict_t * self , edict_t * that ) ;
...
extern int Debug_Soundindex ( const char * name ) ;
extern int Debug_Modelindex ( const char * name ) ;
...
extern void             CTFDrop_Flag( edict_t *ent, gitem_t *item ) ;
...
extern int listSize ( const char *list[] ) ;
