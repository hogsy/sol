...
#define OLD_CS_OBJECTIVES		(OLD_CS_GENERAL+MAX_CLIENTS)
#define	OLD_CS_PLAYERIDS		(CS_OBJECTIVES+MAX_CLIENTS)
#define	OLD_MAX_CONFIGSTRINGS	(OLD_CS_OBJECTIVES+MAX_GENERAL)
//end Knightmare
