...
static void CIN_ReadInfo (cinematic_t *cin)
{
	...
	cin->roqBuffer = static_cast< byte * >( Z_Malloc( cin->vidWidth * cin->vidHeight * 4 * 2 ) );
	...
	if (cin->rawWidth != cin->vidWidth || cin->rawHeight != cin->vidHeight)
	{
		...
		cin->rawBuffer = static_cast< byte * >( Z_Malloc( cin->rawWidth * cin->rawHeight * 4 ) );
	}
}
...
static void CIN_Huff1TableInit (cinematic_t *cin)
{
	...
	if (!cin->hNodes1)
		cin->hNodes1 = static_cast< int * >( Z_Malloc( 256 * 256 * 4 * 2 ) );
...
static void CIN_Huff1Decompress (cinematic_t *cin, const byte *data, int size)
{
	...
	if (!cin->hBuffer)
		cin->hBuffer = static_cast< byte * >( Z_Malloc( cin->vidWidth * cin->vidHeight * 4 ) );
...
static qboolean CIN_StaticCinematic (cinematic_t *cin, const char *name)
{
	...
	cin->pcxBuffer = out = static_cast< byte * >( Z_Malloc( cin->vidWidth * cin->vidHeight * 4 ) );
