...
qboolean QCURL_Init (void)
{
	...
	qcurl_easy_init     = ( CURL * ( * ) () ) Sys_GetProcAddress( CURL_handle, "curl_easy_init" );
	qcurl_easy_cleanup  = ( void ( * )( CURL * ) ) Sys_GetProcAddress( CURL_handle, "curl_easy_cleanup" );
	qcurl_easy_setopt   = ( CURLcode( * )( CURL *, CURLoption, ... ) ) Sys_GetProcAddress( CURL_handle, "curl_easy_setopt" );
	qcurl_easy_getinfo  = ( CURLcode( * )( CURL *, CURLINFO, ... ) ) Sys_GetProcAddress( CURL_handle, "curl_easy_getinfo" );
	qcurl_easy_strerror = ( const char *( * ) ( CURLcode ) ) Sys_GetProcAddress( CURL_handle, "curl_easy_strerror" );

	qcurl_multi_init          = ( CURLM * ( * ) () ) Sys_GetProcAddress( CURL_handle, "curl_multi_init" );
	qcurl_multi_cleanup       = ( CURLMcode( * )( CURLM * ) ) Sys_GetProcAddress( CURL_handle, "curl_multi_cleanup" );
	qcurl_multi_add_handle    = ( CURLMcode( * )( CURLM *, CURL * ) ) Sys_GetProcAddress( CURL_handle, "curl_multi_add_handle" );
	qcurl_multi_remove_handle = ( CURLMcode( * )( CURLM *, CURL * ) ) Sys_GetProcAddress( CURL_handle, "curl_multi_remove_handle" );
	qcurl_multi_info_read     = ( CURLMsg * ( * ) ( CURLM *, int * ) ) Sys_GetProcAddress( CURL_handle, "curl_multi_info_read" );
	qcurl_multi_perform       = ( CURLMcode( * )( CURLM *, int * ) ) Sys_GetProcAddress( CURL_handle, "curl_multi_perform" );

	qcurl_global_init    = ( CURLcode( * )( long int ) ) Sys_GetProcAddress( CURL_handle, "curl_global_init" );
	qcurl_global_cleanup = ( void ( * )() ) Sys_GetProcAddress( CURL_handle, "curl_global_cleanup" );

	qcurl_version = ( char *( * ) () ) Sys_GetProcAddress( CURL_handle, "curl_version" );
