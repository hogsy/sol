...
# ADD LINK32 winmm.lib ws2_32.lib kernel32.lib user32.lib gdi32.lib zlib.lib libjpeg.lib ogg_static.lib vorbisfile_static.lib libpng.lib libcurl.lib glu32.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"LIBC" /out:"./kmquake2.exe" /libpath:"..\..\win32\lib\VC6"
...
# ADD LINK32 ws2_32.lib gdi32.lib kernel32.lib user32.lib winmm.lib zlib.lib libjpeg.lib ogg_static.lib vorbisfile_static.lib libpng.lib libcurl.lib glu32.lib /nologo /subsystem:windows /incremental:no /map /debug /machine:I386 /out:".\kmquake2.exe" /libpath:"..\..\win32\lib\VC6"
# SUBTRACT LINK32 /pdb:none
